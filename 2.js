...
(function (_qc) {
    ...
    var Login = function () {
            ...
            var _showPopup = function (opts) {
                ...
                return window.open(url, 'oauth2Login_' + 1988, 'height=569,width=716, toolbar=no, menubar=no, scrollbars=no, status=no, location=yes, resizable=yes');
            };
